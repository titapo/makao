...
{
    g_context.view.init(g_viewContainer.baseArea/*FIXME(titapo) use container.createView()*/, g_actionList);
...
function Init()
{
    ...
    g_viewContainer = new ViewContainer(document.getElementById("base-area"));
    InitView();
