...
function StorageBase(tree, factory)
{
    this._init(tree, factory)
}
...
function BrowserStorage(tree, storageTarget, factory)
{
    this._init(tree, factory);
...
function PlainStorage(tree, factory)
{
    this._init(tree, factory);
}
...
PlainStorage.prototype.loadNode = function()
{
    ...
    form.submit = function (values)
    {
        ...
        _this.tree.loadChild(node, this.path);
        return true;
    };
